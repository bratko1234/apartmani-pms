...
const strings = new LocalizedStrings({
  ...
  sr: {
    GENERIC_ERROR: 'Došlo je do neočekivane greške.',
    CHANGE_LANGUAGE_ERROR: 'Došlo je do greške prilikom promjene jezika.',
    UPDATED: 'Izmjene uspješno sačuvane.',
    GO_TO_HOME: 'Idi na početnu stranicu',
    FULL_NAME: 'Puno ime',
    EMAIL: 'Email',
    PASSWORD: 'Lozinka',
    EMAIL_ALREADY_REGISTERED: 'Ova email adresa je već registrovana.',
    ...
    PASSWORD_ERROR: 'Lozinka mora imati najmanje 6 znakova.',
    ...
    CURRENCY: env.CURRENCY,
    DELETE_AVATAR_CONFIRM: 'Da li ste sigurni da želite obrisati sliku?',
    ...
    BOOKING_STATUS_DEPOSIT: 'Depozit',
    BOOKING_STATUS_PAID: 'Plaćeno',
    BOOKING_STATUS_RESERVED: 'Rezervisano',
    BOOKING_STATUS_CANCELLED: 'Otkazano',
    FROM: 'Od',
    TO: 'Do',
    OPTIONAL: 'Opcioni parametri',
    AND: 'i',
    RECORD_TYPE_ADMIN: 'Admin',
    RECORD_TYPE_AGENCY: 'Agencija',
    RECORD_TYPE_USER: 'Stanar',
    TYPE: 'Tip',
    CONFIRM: 'Potvrdi',
    USER: 'Korisnik',
    INFO: 'Informacija',
    USER_TYPE_REQUIRED: 'Molimo popunite polje: Tip',
    FIX_ERRORS: 'Molimo ispravite greške.',
    SEND_MESSAGE: 'Pošalji poruku',
    VERIFIED: 'Verifikovan nalog',
    PROPERTY: 'nekretnina',
    PROPERTIES: 'nekretnine',
    RESEND_ACTIVATION_LINK: 'Ponovo pošalji link za aktivaciju naloga',
    ACTIVATION_EMAIL_SENT: 'Email za aktivaciju je poslan.',
    EMAIL_NOT_VALID: 'Neispravna email adresa',
    PHONE_NOT_VALID: 'Neispravan broj telefona',
    BIRTH_DATE_NOT_VALID: `Stanar mora imati najmanje ${env.MINIMUM_AGE} godina.`,
    FORM_ERROR: 'Molimo ispravite greške.',
    ALL: 'Sve',
    AGENCY: 'Agencija',
    STATUS: 'Status',
    OPTIONS: 'Opcije',
    ...
    BIRTH_DATE_NOT_VALID_PART1: 'Stanar mora imati najmanje',
    BIRTH_DATE_NOT_VALID_PART2: 'godina.',
    PAY_LATER: 'Dozvoli plaćanje kasnije',
    NAME: 'Ime',
    LONGITUDE: 'Geografska dužina',
    LATITUDE: 'Geografska širina',
    BLACKLISTED: 'Crna lista',
    BLACKLISTED_TOOLTIP: 'Korisnici na crnoj listi više nemaju pristup platformi.',
  },
})
