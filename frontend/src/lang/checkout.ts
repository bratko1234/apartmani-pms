...
const strings = new LocalizedStrings({
  ...
  sr: {
    ...
    BOOKING_DETAILS: 'Vaši podaci o rezervaciji',
    DAYS: 'Dana',
    PROPERTY: 'Nekretnina',
    AGENCY: 'Agencija',
    COST: 'Ukupno',
    RENTER_DETAILS: 'Podaci o klijentu',
    EMAIL_INFO: 'Primaćete potvrdu na ovu adresu.',
    ...
    PAY_LATER_SUCCESS: 'Vaša rezervacija je uspješno izvršena. Poslali smo vam email potvrde.',
    PAYMENT_OPTIONS: 'Opcije plaćanja',
    PAY_LATER: 'Plati kasnije',
    PAY_LATER_INFO: 'Besplatne izmjene i otkazivanje',
    PAY_ONLINE: 'Plati online',
