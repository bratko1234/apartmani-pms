...
const strings = new LocalizedStrings({
  ...
  sr: {
    ...
    PASSWORD_ERROR: 'Lozinka mora sadržavati najmanje 6 karaktera.',
    ...
    EMAIL_NOT_VALID: 'Nevažeća email adresa',
    PHONE_NOT_VALID: 'Nevažeći broj telefona',
    ALL: 'Sve',
    TOS: 'Pročitao/la sam i prihvatam uslove korištenja.',
    BIRTH_DATE: 'Datum rođenja',
    RECAPTCHA_ERROR: 'reCAPTCHA greška',
    TOS_ERROR: 'Molimo prihvatite uslove korištenja.',
    BIRTH_DATE_NOT_VALID: `Morate imati najmanje ${env.MINIMUM_AGE} godina.`,
    BIRTH_DATE_NOT_VALID_PART1: 'Zakupac mora imati najmanje',
