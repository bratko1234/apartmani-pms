...
const strings = new LocalizedStrings({
  ...
  sr: {
    TITLE1: `${env.WEBSITE_NAME} - Vaš premier servis za iznajmljivanje nekretnina`,
    SUBTITLE1: 'Vaš pouzdani partner za iznajmljivanje nekretnina',
    CONTENT1: `U ${env.WEBSITE_NAME}, razumijemo da je svako putovanje jedinstveno. Posvećeni smo pružanju raznovrsne ponude nekretnina koje zadovoljavaju svaku potrebu putovanja. Bilo da istražujete grad, putujete poslovno ili tražite avanturu, naše pouzdane usluge iznajmljivanja nekretnina osiguravaju da vaša avantura počne bez problema. Naša misija je pružiti izuzetnu korisničku uslugu, čineći vaše iskustvo ugodnim i bez stresa. Sa konkurentnim cijenama, raznovrsnim dobro održavanim nekretninama i posvećenim timom spremnim da vam pomogne, težimo da budemo vaš pouzdani partner. Izaberite ${env.WEBSITE_NAME} za sve vaše potrebe iznajmljivanja nekretnina i iskusite slobodu istraživanja vlastitim tempom.`,
    TITLE2: `Zašto izabrati ${env.WEBSITE_NAME}`,
    SUBTITLE2: 'Iskusite izvrsnost na svakom putovanju',
    CONTENT2: 'Uživajte u nenadmašnoj pogodnosti, pouzdanosti i vrijednosti uz naš servis za iznajmljivanje nekretnina. Od jednostavnih rezervacija do visokokvalitetnih nekretnina, mi smo vaš pouzdani partner za putovanja.',
